...
사용:
    python3 v3/scripts/validators/validate.py <file.hwpx>                # JSON 출력
    python3 v3/scripts/validators/validate.py <file.hwpx> --format=text  # 사람용 텍스트
    python3 v3/scripts/validators/validate.py <file.hwpx> --strict       # 경고도 실패로
