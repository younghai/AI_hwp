...
3. 실패 항목 진단
   - **단계 5 wasm magic 불일치** → Vite cache stale. `rm -rf v3/client/node_modules/.vite v3/node_modules/.vite` + dev 서버 재시작
...
4. 수동 추가 검증 (edge case)
   ...
   python3 v3/tools/verify-hwpx-markers.py /tmp/edge1.hwpx OneSentence
