...
#
# Usage:
#   bash v3/hooks/pre-completion-checklist.sh
#
# Exit 0 = 완료 선언해도 OK
# Exit 1 = 회귀/누락 있음 — 사용자에게 실패 보고
#
# v3 는 자립형: 모든 경로가 v3/ 내부로 해결된다.
...
if lsof -nP -i:5190 -i:8790 2>/dev/null | grep -q LISTEN; then
