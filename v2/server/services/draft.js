...
function buildPrompt({ effectiveText, hasUploadedTemplate, title, docLabel, companyName, goal, notes, fallbackToc }) {
  const sharedDiagramSpec = `다이어그램 data 형식:
...
export async function buildDraftWithAI(input) {
  ...
  const prompt = buildPrompt({
    effectiveText, hasUploadedTemplate, title, docLabel, companyName, goal, notes, fallbackToc
  })
