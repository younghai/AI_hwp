...
3. 실패 항목 진단
   - **단계 5 wasm magic 불일치** → Vite cache stale. `rm -rf v2/client/node_modules/.vite v2/node_modules/.vite` + dev 서버 재시작
...
4. 수동 추가 검증 (edge case)
   ...
   python3 v2/tools/verify-hwpx-markers.py /tmp/edge1.hwpx OneSentence
