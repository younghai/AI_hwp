...
| 목적 | 명령 |
|------|------|
| dev 서버 시작 (server+client 병행) | `cd v2 && npm run dev` |
...
| **E2E smoke test** | `bash v2/tools/smoke-test.sh` |
| **HWPX 내용 검증** | `python3 v2/tools/verify-hwpx-markers.py <file> MARKER1 MARKER2` |
